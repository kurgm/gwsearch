...
return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),s[e]=t),t}}),i("ik1O3").register(JSON.parse('{"dPT7b":"worker.5aeeba66.js","fi9ib":"dag.5980bf60.txt"}'));/// <reference lib="webworker" />
class a{/**
