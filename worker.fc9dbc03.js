...
return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),s[e]=t),t}}),i("ik1O3").register(JSON.parse('{"dPT7b":"worker.fc9dbc03.js","fi9ib":"dag.4c12667f.txt"}'));/// <reference lib="webworker" />
class a{/**
