...
return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),s[e]=t),t}}),i("ik1O3").register(JSON.parse('{"dPT7b":"worker.efa1dd15.js","fi9ib":"dag.67579cad.txt"}'));/// <reference lib="webworker" />
class a{/**
